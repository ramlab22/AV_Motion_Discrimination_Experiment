...
for i = 1:length(dotInfo.cohFreq)
    for j = 1:dotInfo.cohFreq(i)   
...
for k = 1:length(dotInfo.random_incorrect_opacity_list)% 0 = Catch Trial, Insert a 1 coherence to cohSet at that index
