function [x, y, fig, coeff_p_values,mu,std_gaussian] = psychometric_plotter(prob_Right, prob_Left, dotInfo, chosen_threshold,save_name)
...
[fig, coeff_p_values,mu,std_gaussian]= createFit_NormCDF(plot_data(:,1), plot_data(:,2)/100, dotInfo, chosen_threshold,save_name); 
% figure(1)
% clf
% 
