function [fig] = psychometric_plotter_1_direction_modalities(AUD_directional_probability, VIS_directional_probability, direction, audInfo, dotInfo, save_name)
    ...
    [fig] = createFit_NormCDF_1_direction_modalities(AUD.plot_data(:,1), AUD.plot_data(:,2)/100, VIS.plot_data(:,1), VIS.plot_data(:,2)/100, direction, audInfo, dotInfo, save_name); 
