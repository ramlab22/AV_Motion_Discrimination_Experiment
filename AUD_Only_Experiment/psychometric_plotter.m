function [x, y, fig, coeff_p_values,ci] = psychometric_plotter(prob_Right, prob_Left, audInfo, save_name)
...
[fig, coeff_p_values,ci] = createFit_NormCDF(plot_data(:,1), plot_data(:,2)/100, audInfo, save_name); 
% figure(1)
% clf
% 
