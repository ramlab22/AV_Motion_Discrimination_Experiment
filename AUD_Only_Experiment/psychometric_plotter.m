function [x, y, fig, coeff_p_values,ci,threshold,std_gaussian] = psychometric_plotter(prob_Right, prob_Left,audInfo, chosen_threshold,save_name)
...
[fig, coeff_p_values,ci,threshold,std_gaussian] = createFit_NormCDF(plot_data(:,1), plot_data(:,2)/100, audInfo, chosen_threshold,save_name); 
% figure(1)
% clf
% 
