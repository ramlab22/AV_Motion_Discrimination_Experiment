function [x_scatter, y_scatter, fig, mu, std_gaussian, xData, yData, curve_xvals, curve_yvals] = psychometric_plotter(dataout,prob_Right, prob_Left, audInfo, save_name, fig_color)
    ...
    [fig, mu, std_gaussian, xData, yData, curve_xvals, curve_yvals] = createFit_NormCDF_FLRnCLNG(dataout,scatter_plot_data(:,1), scatter_plot_data(:,2)/100, audInfo, save_name, fig_color); 
end
