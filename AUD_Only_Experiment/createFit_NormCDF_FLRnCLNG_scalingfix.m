function [fig, mu, std_gaussian_scaled, xData, yData, curve_xvals, curve_yvals] = createFit_NormCDF_FLRnCLNG_scalingfix(dataout,coh_list, probability_rightward_response, audInfo, save_name, fig_color)
