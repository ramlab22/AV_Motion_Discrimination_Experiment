function [CAM, speaker2_6_noise, speaker3_7_noise, speaker4_8_noise] = makeCAM_and_NOISE_update(cLvl, dur, silence, Fs, dB_noise_reduction)
...
N7 = (rand(samples,1)-.5)*noise_reduction_scalar;
N8 = (rand(samples,1)-.5)*noise_reduction_scalar;
N9 = (rand(samples,1)-.5)*noise_reduction_scalar;
