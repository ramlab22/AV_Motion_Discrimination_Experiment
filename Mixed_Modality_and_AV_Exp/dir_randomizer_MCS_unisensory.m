function [random_dir_list] = dir_randomizer_MCS_unisensory(audInfo)
...
%locations and catch trial(1 coherence) locations
    ...
    try
    random_dir_list = zeros(1,audInfo.n_aud_trials);
    catch
    random_dir_list = zeros(1,audInfo.n_dot_trials);
    end
