function [fig, BF_AUD_VIS, BF_AUD_AV, BF_VIS_AV, AUD_threshold, VIS_threshold, AV_threshold, AUD_std, VIS_std, AV_std] = createFit_NormCDF_modalities(AUD_coh_list, AUD_pc, VIS_coh_list, VIS_pc, AV_coh_list, AV_pc, audInfo, dotInfo, AVInfo, save_name)
    % Fit: 'untitled fit 1'.
    ...
    AV_threshold = AV_mdl.Coefficients{1, 1};

    AUD_std = AUD_mdl.Coefficients{1, 2};
    VIS_std = VIS_mdl.Coefficients{1, 2};
    AV_std = AV_mdl.Coefficients{1, 2};
