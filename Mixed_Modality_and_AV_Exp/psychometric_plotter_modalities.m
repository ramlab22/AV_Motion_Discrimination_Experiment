function [fig, AUD_curve_xvals, VIS_curve_xvals,...
    ...
    psychometric_plotter_modalities(AUD_dataout,VIS_dataout,AV_dataout,AUD_prob_Right, AUD_prob_Left, VIS_prob_Right, VIS_prob_Left,...
...
if AVInfo.n_AV_trials ~= 0 & dotInfo.n_vis_trials ~=0 & audInfo.n_aud_trials ~=0
    ...
    [fig, AUD_curve_xvals, VIS_curve_xvals,...
               AV_curve_xvals, AUD_curve_yvals,VIS_curve_yvals,AV_curve_yvals,...
               AUD_xData, AUD_yData,VIS_xData, VIS_yData,AV_xData, AV_yData,...
               AUD_mu, VIS_mu, AV_mu, AUD_std_gaussian, VIS_std_gaussian, AV_std_gaussian,AUD_prop_Rresp_zerocoh,VIS_prop_Rresp_zerocoh,AV_prop_Rresp_zerocoh] = ...
                            createFit_NormCDF_modalities(AUD_dataout,VIS_dataout,AV_dataout,AUD.plot_data(:,1), AUD.plot_data(:,2)/100,...
                                             VIS.plot_data(:,1), VIS.plot_data(:,2)/100,AV_vis.plot_data(:,1), AV_vis.plot_data(:,2)/100,...
                                             audInfo, dotInfo, AVInfo,save_name); 
end
